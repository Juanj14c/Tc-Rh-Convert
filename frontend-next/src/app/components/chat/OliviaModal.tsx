...
export default function OliviaModal({
  isOpen,
  onClose,
  isLoading = false,
  error = null,
  ...
  return (
    <div
      className="olivia-modal-overlay"
      onClick={onClose}
    >
      <div
        ...
        <div className="olivia-modal__body">
          {isLoading && (
            <div className="olivia-modal__loading">
              <Loader2
                size={24}
                className="olivia-modal__spinner"
              />

              <div>
                <strong>
                  OlivIA está analizando el caso
                </strong>

                <p>
                  Estamos revisando la conversación
          ...
          {!isLoading &&
            ...
            !result && (
              <div className="olivia-modal__empty">
                ...
                <p>
                  Cuando OlivIA reciba la
                  conversación, aquí aparecerán el
                  resumen, la recomendación y una
                  respuesta sugerida.
                </p>
              </div>
            )}
